...
class Config():
    ...
    def __init__(self, data_path=None, model='ChronoNet', dataset='SZ2', fs=None, CH=None, frame=2, stride=1, stride_s=0.5, boundary=0.5, batch_size=64, sample_type='subsample', factor=5, l2=0, lr=0.01, dropoutRate=0, nb_epochs=50, class_weights = {0:1, 1:1}, cross_validation='fixed', save_dir='net/save_dir', num_classes=2, pre_ictal_window=30, inter_ictal_subsample_factor=0.3, modalities=None):
        ...
        self.inter_ictal_subsample_factor = inter_ictal_subsample_factor
        
        # Multi-modal parameters
        self.modalities = modalities if modalities is not None else ['eeg']
